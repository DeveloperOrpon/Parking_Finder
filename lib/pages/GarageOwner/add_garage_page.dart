                        ...
                        children: [
                          ...
                          ListView(
                            children: [
                              ...
                              Text("Enter Spot Details", style: blackBoldText),
                              const SizedBox(height: 7),
                              Text("Image of Spot", style: blackBoldSmallText),
                              const SizedBox(height: 7),
                              Container(
                              ...
                              Row(
                                children: [
                                  Expanded(
                                    child: InkWell(
                                      onTap: () {
                                        mapProvider.addFacilityFunction("CCTV");
                                      },
                                      child: Container(
                                        height: 80,
                                        decoration: BoxDecoration(
