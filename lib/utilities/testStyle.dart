...
TextStyle grayTextStyle = const TextStyle(
  color: Colors.grey,
  fontSize: 16,
);
...
TextStyle appThemeTextStyle = TextStyle(
  color: AppColors.primaryColor,
  fontSize: 18,
  fontWeight: FontWeight.bold,
);
TextStyle whiteBoldText = const TextStyle(
  color: Colors.white,
...
TextStyle blackPrimaryText = TextStyle(
  color: AppColors.primaryColor,
  fontWeight: FontWeight.w600,
  fontSize: 18,
);

TextStyle blackBoldSmallText = const TextStyle(
  color: Colors.black,
  fontWeight: FontWeight.w600,
  fontSize: 16,
);

TextStyle grayLowColor = const TextStyle(
  color: Colors.grey,
  fontSize: 18,
  letterSpacing: 1.5,
);
